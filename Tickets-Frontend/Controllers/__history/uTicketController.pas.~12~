...
type
  ...
  TTicketController = class
    ...
    public
      ...
      procedure EditarTicket(idTicket: Integer; updateTicket: TUpdateTicket; OnExecutarAposAdicionarTicket: TExecutarAposConsulta);
...
procedure TTicketController.EditarTicket(idTicket: Integer;
  updateTicket: TUpdateTicket;
  OnExecutarAposAdicionarTicket: TExecutarAposConsulta);
var
  Thread: TThread;
begin
  Thread := TThread.CreateAnonymousThread(
    procedure
    begin
      TicketDAO.EditarTicket(idTicket, updateTicket);
    end);
