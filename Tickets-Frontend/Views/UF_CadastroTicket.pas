...
begin
  ...
  lblTitulo.text := ifthen(Fid > 0, 'Editando ticket: ' + Fid.ToString, 'Inserindo ticket');
end;
...
begin
  ...
  begin
    ...
    FuncionarioId := TFuncionarioModel(ObterObjetoSelecionado(cbFuncionario)).Id;
...
begin
  ...
  begin
    ...
    if cbFuncionario.ItemIndex = INDEX_COMBOBOX_TODOS_FUNCIONARIOS then
      ...
      idFuncionarios.add(TFuncionarioModel(ObterObjetoSelecionado(cbFuncionario)).Id);
  end;
