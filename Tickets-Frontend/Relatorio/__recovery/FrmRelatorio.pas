...
begin
  ...
  frxReportTickets.Variables.Variables['Periodo'] := QuotedStr('Período '+
                                                       FormatDateTime('dd/mm/yyyy', datePeriodoInicial.Date) +
                                                       ' até '+
                                                       FormatDateTime('dd/mm/yyyy', datePeriodoFinal.Date)
                                                       );
  frxReportTickets.Variables.Variables['FiltrosAplicados'] := QuotedStr(ifthen(cbFuncionario.ItemIndex > -1,
                                                                               'Funcionário: ' + cbFuncionario.text,
                                                                               ''
                                                                              ) +
                                                                        ', Situação dos Tickets: ' + rgSituacaoTicket.Items[rgSituacaoTicket.ItemIndex]
                                                                       );
...
begin
  ...
  cbFuncionario.Items.Add('Todos Funcionários');
