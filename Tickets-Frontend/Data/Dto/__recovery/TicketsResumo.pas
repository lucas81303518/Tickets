...
begin
  ...
  FTicketDataSet.FieldDefs.Add('situacao', ftString, 100);
  FTicketDataSet.FieldDefs.Add('dataEntrega', ftDateTime);

  FTicketDataSet.FieldDefs.Add('nome', ftString, 255);
  FTicketDataSet.FieldDefs.Add('cpf', ftString, 14);
  FTicketDataSet.FieldDefs.Add('situacaoFuncionario', ftString, 100);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        FTicketDataSet.FieldByName('situacaoFuncionario').AsString := ifThen(EmployeeObject.GetValue('funcionario').GetValue<string>('situacao') = 'A',
                                                                             'Ativo', 'Inativo'
                                                                            );
        ...
        FTicketDataSet.FieldByName('situacao').AsString            := ifThen(TicketObject.GetValue<string>('situacao') = 'A',
                                                                             'Ativo', 'Inativo'
                                                                            );
